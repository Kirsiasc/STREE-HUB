-- Native UI + Key System + aFz Detector by kirsiasc
...
Title.Text = "Native Loader - Key System"
...
Hint.Text = "Dapatkan key di: work.ink/KirsiascKey"
...
-- GANTI KEY INI SESUAI YANG KAMU MAU
local CorrectKey = "aFzOP-999"
...
Verify.MouseButton1Click:Connect(function()
	if TextBox.Text == CorrectKey then
		...
		-- Tambahkan script GUI utama kamu di sini
		-- loadstring(game:HttpGet("https://raw.githubusercontent.com/kirsiasc/REPO/main/Hunters_aFz.lua"))()
	else
